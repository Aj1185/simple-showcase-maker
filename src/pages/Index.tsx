...
const Index = () => {
  ...
  const skills = [
    ...
    { name: 'Python', level: 80, color: 'pink' },
    { name: 'UI/UX Design', level: 88, color: 'purple' },
    { name: 'Cloud Architecture', level: 82, color: 'blue' }
  ] as const;
      ...
      <section id="skills" className="chapter-section min-h-screen py-32">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <p className="text-xl font-inter text-gray-700 dark:text-muted-foreground max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {skills.map((skill, index) => (
              <GlassCard key={skill.name} glowColor={skill.color} className="p-8">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-xl font-space-grotesk font-semibold text-slate-800 dark:text-white">{skill.name}</h3>
                ...
                <div className="w-full bg-muted/30 rounded-full h-3 overflow-hidden">
                  <div 
                    className={`h-full bg-gradient-to-r transition-all duration-1000 delay-${index * 100} ${
                      skill.color === 'purple' ? 'from-primary to-primary/60' :
                      skill.color === 'blue' ? 'from-secondary to-secondary/60' :
                      skill.color === 'pink' ? 'from-accent to-accent/60' :
